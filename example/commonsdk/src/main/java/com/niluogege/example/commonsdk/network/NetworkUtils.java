...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            BaseApplication.getApplication().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            BaseApplication.getApplication().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            ILog.d("isAvailableByPing errorMsg", result.errorMsg);
        }
        if (result.successMsg != null) {
            ILog.d("isAvailableByPing successMsg", result.successMsg);
        }
        return ret;
    }
